...
```
I see that there are the most cases in California and Texas, and the initial problem was that the map was compressed and looked squished. I tried to fix that with fig.width. Also, on the legend, it is hard to visualise the actual number of people who had COVID. 
